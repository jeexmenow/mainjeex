...
class CategoryListView(PostDetail):
    model = Post
    ...
    def get_queryset(self):
        ...
        queryset = Post.objects.filter(category=self.category).order.by('-created_at')
        return queryset
...
def subscribe(request, pk):
    ...
    message = 'Вы успешно подписались на расписку новостей данной категории!'
